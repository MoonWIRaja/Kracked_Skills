# Generic Adapter — README

## Setup
For AI tools without a dedicated KD adapter, you can manually configure KD by following the instructions in `instructions.md`.

## Supported AI Tools with Dedicated Adapters
...
## Usage
Type `/KD-*` commands in your AI tool's chat interface.
